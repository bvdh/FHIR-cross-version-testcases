...
Usage: #example
* insert crossversionTestWithRationale( #pass, "http://hl7.org/fhir/StructureDefinition/Encounter|5.0.0", 
...
InstanceOf: Encounter
Usage: #example
* insert crossversionTestWithRationale( #fail, "http://hl7.org/fhir/StructureDefinition/Encounter|5.0.0", 
